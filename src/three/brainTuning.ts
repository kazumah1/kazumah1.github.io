...
export const DIM_FACTOR = 0.52; // Dim factor for base layer while a nav spot is highlighted.
...
export const NAVIGATION_SCALE_TARGET = 0.98; // Landing brain target scale before route push.
export const NAVIGATION_Y_TARGET = -0.08; // Landing brain y target so it aligns with section-header area.
export const NAVIGATION_TRANSFORM_LERP = 0.16; // Transform smoothing during route transition.
export const SECTION_HEADER_SCALE = 0.98; // Final scale for full-brain context header.
export const SECTION_HEADER_Y = -0.08; // Lower section header brain to avoid top clipping.
export const SECTION_HEADER_CAMERA_Z = 2.95;
export const SECTION_HEADER_CAMERA_FOV = 34;
