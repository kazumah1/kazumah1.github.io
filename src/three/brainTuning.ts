...
export const SPRING_K = 18; // Increase to pull points faster back to rest.
export const DAMPING = 0.9; // Increase to remove motion faster and reduce oscillation.
export const REPULSION_RADIUS = 0.34; // Increase to affect a wider local area around cursor.
export const REPULSION_STRENGTH = 0.85; // Increase to push points farther from cursor.
export const MAX_DISPLACEMENT = 0.016; // Increase to allow larger local deformation.
...
export const DIM_FACTOR = 0.66; // Dim factor for base layer while a nav spot is highlighted.
...
export const OVERLAY_OPACITY = 0.95; // Hover highlight visibility without changing point size.
